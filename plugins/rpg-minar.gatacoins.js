...
let pp = 'https://media.tvalacarta.info/programas/0/clantve/44-gatos/aida-la-proyecto-robot.jpg'
...
await conn.sendFile(m.chat, pp, 'proyecto.jpg', gat, fkontak)
...
handler.help = ['minar2']
handler.tags = ['proyecto']
handler.command = ['minar2', 'miming2', 'mine2', 'minarproyectocoins', 'minarcoins', 'minarproyecto'] 
handler.fail = null
handler.exp = 0
